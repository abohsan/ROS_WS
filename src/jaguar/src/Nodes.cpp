...
void Nodes::keyboard_Callback(const std_msgs::String::ConstPtr &msg)
{
    ...
    else if (msg->data == "f6u")
    {
    }
    else if (msg->data == "f6d")
    {
    }
    else if (msg->data == "f7u")
    {
    }
    else if (msg->data == "f7d")
    {
    }
    else
    {
...
void Nodes::publisherFliperJointStatus()
{
    ...
    joint_state.position[3] =  jaguar->getFrontLeftFliperAngle();
    joint_state.position[4] =  jaguar->getBackLeftFliperAngle();
    joint_state.position[5] =  jaguar->getFrontRightFliperAngle();
    joint_state.position[6] =  jaguar->getBackRightFliperAngle();
